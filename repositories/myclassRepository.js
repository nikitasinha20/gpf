...
const myclass_1 = require('../models/myclass');
const dynamic_repository_1 = require('nodedata/core/dynamic/dynamic-repository');
let MyclassRepository = class MyclassRepository extends dynamic_repository_1.DynamicRepository {
};
MyclassRepository = __decorate([
