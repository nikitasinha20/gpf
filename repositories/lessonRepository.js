...
let LessonRepository = class LessonRepository extends dynamic_repository_1.DynamicRepository {
};
LessonRepository = __decorate([
    decorators_1.repository({ path: 'lesson', model: lesson_1.lesson }), 
