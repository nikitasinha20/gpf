...
const mycollection_1 = require('../models/mycollection');
const dynamic_repository_1 = require('nodedata/core/dynamic/dynamic-repository');
let CollectionRepository = class CollectionRepository extends dynamic_repository_1.DynamicRepository {
};
CollectionRepository = __decorate([
    decorators_1.repository({ path: 'mycollection', model: mycollection_1.mycollection }), 
